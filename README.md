...
Profiles (настройки) – валюта отображения, язык, тема и т. д.

Assets Catalog – справочник монет/токенов.

Market Data – цены, котировки, кэширование.

Portfolio – транзакции, позиции, оценка стоимости.

Alerts – хранение правил алертов и проверка условий.

Notifications – отправка push/email/telegram сообщений.

API Gateway / BFF – единая точка входа для мобильного клиента.
